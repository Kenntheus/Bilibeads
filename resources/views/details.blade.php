                    ...
                    <div class="swiper-slide product-card">
                        <div class="pc__img-wrapper">
                            ...
                            <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                                ...
                                <input type="hidden" name="price" value="{{$rproduct->sale_price == '' ? $rproduct->sale_price : $rproduct->sale_price}}">
                                <button
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="{{route('shop.product.details',['product_slug'=>$rproduct_slug])}}">{{$rproduct->name}}</a></h6>
                            <div class="product-card__price d-flex">
                                <span class="money price">
                                    @if($rproducts->sale_price)
                                    ₱{{$rproduct->sale}}
                                    @endif
                                </span>
                            </div>
